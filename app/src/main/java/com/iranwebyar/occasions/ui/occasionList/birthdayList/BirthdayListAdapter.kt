...
import com.iranwebyar.occasions.databinding.ItemBirthdayViewBinding
...
constructor(birthdayItemViewModelList: List<OccasionsPOJO.Occasion?>?, callback: BirthdayListFragmentCallback) : BaseAdapter<OccasionsPOJO.Occasion?>() {
    var callback: BirthdayListFragmentCallback? = callback
    ...
    override fun onCreateViewHolderBase(parent: ViewGroup?, viewType: Int): BaseViewHolder {
        publicParent = parent
        val mBirthdayViewBinding = ItemBirthdayViewBinding
            .inflate(LayoutInflater.from(parent!!.context), parent, false)
        return BirthdayViewHolder(mBirthdayViewBinding)
    }

    inner class BirthdayViewHolder(var mBinding: ItemBirthdayViewBinding) : BaseViewHolder(mBinding.root),
